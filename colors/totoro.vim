...
hi ColorColumn guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi Cursor guifg=#171b16 guibg=#2d3654 guisp=NONE blend=NONE gui=NONE
hi CursorColumn guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi CursorLine guifg=NONE guibg=#1f2335 guisp=NONE blend=NONE gui=NONE
hi CursorLineNr guifg=#171b16 guibg=#7386d0 guisp=NONE blend=NONE gui=bold
...
hi DiagnosticSignError guifg=#ef6a6a guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignHint guifg=#5bcefa guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignInfo guifg=#7ec2ff guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignWarn guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi DiagnosticVirtualTextHint guifg=#7ec2ff guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextInfo guifg=#7ec2ff guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextWarn guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi DiffAdd guifg=#171b16 guibg=#5bcefa guisp=NONE blend=NONE gui=NONE
hi DiffAdded guifg=#5bcefa guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi DiffChange guifg=#171b16 guibg=#2d3654 guisp=NONE blend=NONE gui=NONE
hi DiffDelete guifg=#171b16 guibg=#ef6a6a guisp=NONE blend=NONE gui=bold
hi DiffRemoved guifg=#ef6a6a guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi DiffText guifg=#171b16 guibg=#2d3654 guisp=NONE blend=NONE gui=bold
hi Directory guifg=#7ec2ff guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi Error guifg=#2d3654 guibg=#eea9d3 guisp=NONE blend=NONE gui=NONE
hi ErrorMsg guifg=#ef6a6a guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi FloatShadow guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi FloatShadowThrough guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi FoldColumn guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi Folded guifg=#c8a5f5 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi Function guifg=#a5b4ff guibg=NONE guisp=NONE blend=NONE gui=NONE
hi GitSignsAdd guifg=#5bcefa guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi GitSignsChange guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi GitSignsDelete guifg=#ef6a6a guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi IblIndent guifg=#171b16 guibg=NONE guisp=NONE blend=NONE gui=nocombine
hi IblScope guifg=#2d3654 guibg=NONE guisp=NONE blend=NONE gui=nocombine
hi IblWhitespace guifg=#171b16 guibg=NONE guisp=NONE blend=NONE gui=nocombine
hi Identifier guifg=#cbcfe7 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi Ignore guifg=#171b16 guibg=NONE guisp=NONE blend=NONE gui=underline
hi IncSearch guifg=#171b16 guibg=#eea9d3 guisp=NONE blend=NONE gui=NONE
hi Keyword guifg=#5bcefa guibg=NONE guisp=NONE blend=NONE gui=NONE
hi LazyButton guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi LazyButtonActive guifg=#171b16 guibg=#a5b4ff guisp=NONE blend=NONE gui=NONE
...
hi LazyH1 guifg=#a5b4ff guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi LazyH2 guifg=#a5b4ff guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi LazyNormal guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi LineNr guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi LspBorderBG guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi MasonHeader guifg=#cbcfe7 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi MasonHeading guifg=NONE guibg=NONE guisp=NONE blend=NONE gui=NONE
hi MasonHighlight guifg=#7ec2ff guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi MasonMuted guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi Normal guifg=#eeeeee guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi Number guifg=#7ec2ff guibg=NONE guisp=NONE blend=NONE gui=NONE
hi NvimInternalError guifg=#171b16 guibg=#ef6a6a guisp=NONE blend=NONE gui=NONE
hi Pmenu guifg=#cbcfe7 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi PmenuSbar guifg=NONE guibg=#2d3654 guisp=NONE blend=NONE gui=NONE
hi PmenuSel guifg=#171b16 guibg=#a5b4ff guisp=NONE blend=NONE gui=NONE
...
hi RedrawDebugClear guifg=#171b16 guibg=#2d3654 guisp=NONE blend=NONE gui=NONE
hi RedrawDebugComposed guifg=#171b16 guibg=#a5b4ff guisp=NONE blend=NONE gui=NONE
hi RedrawDebugNormal guifg=NONE guibg=NONE guisp=NONE blend=NONE gui=reverse
hi RedrawDebugRecompose guifg=#171b16 guibg=#eea9d3 guisp=NONE blend=NONE gui=NONE
hi ScrollbarCursor guifg=#171b16 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarCursorHandle guifg=#171b16 guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarError guifg=#2d3654 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarErrorHandle guifg=#2d3654 guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarGitAdd guifg=#5bcefa guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarGitAddHandle guifg=#5bcefa guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarGitChange guifg=#2d3654 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarGitChangeHandle guifg=#2d3654 guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarGitDelete guifg=#ef6a6a guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarGitDeleteHandle guifg=#ef6a6a guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarHandle guifg=NONE guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarHint guifg=#5bcefa guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarHintHandle guifg=#5bcefa guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarInfo guifg=#5bcefa guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarInfoHandle guifg=#5bcefa guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarMisc guifg=#eea9d3 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarMiscHandle guifg=#eea9d3 guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarSearch guifg=#2d3654 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarSearchHandle guifg=#2d3654 guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi ScrollbarWarn guifg=#ef6a6a guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarWarnHandle guifg=#ef6a6a guibg=#171b16 guisp=NONE blend=0 gui=NONE
hi Search guifg=#171b16 guibg=#5bcefa guisp=NONE blend=NONE gui=NONE
hi SignColumn guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi StatusLine guifg=#cbcfe7 guibg=#171b16 guisp=NONE blend=NONE gui=bold
hi StatusLineNC guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=bold
...
hi TabLine guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi TabLineFill guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi TabLineSel guifg=#171b16 guibg=#a5b4ff guisp=NONE blend=NONE gui=bold
hi TabLineSelSep guifg=#a5b4ff guibg=#171b16 guisp=NONE blend=NONE gui=bold
hi TabLineSep guifg=#171b16 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi TelescopeBorder guifg=#2d3654 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi TelescopeMatching guifg=#171b16 guibg=#eea9d3
...
hi TelescopeTitle guifg=#5bcefa guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi User4 guifg=#cbcfe7 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
...
hi VertSplit guifg=#171b16 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi Visual guifg=#171b16 guibg=#7ec2ff guisp=NONE blend=NONE gui=NONE
hi WarningMsg guifg=#ef6a6a guibg=NONE guisp=NONE blend=NONE gui=NONE
hi WhichKey guifg=#cbcfe7 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi WhichKeyBorder guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi WhichKeyDesc guifg=#5bcefa guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi WhichKeyFloat guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi WhichKeyGroup guifg=NONE guibg=#171b16 guisp=NONE blend=NONE gui=NONE
hi WhichKeySeparator guifg=#2d3654 guibg=#171b16 guisp=NONE blend=NONE gui=NONE
